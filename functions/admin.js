...
<div><label>每码允许设备</label><select id="devices"><option value="1">1 台</option><option value="2" selected>2 台</option><option value="3">3 台</option></select></div>
</div>
...
<section class="card">
<h2>重置设备绑定</h2>
<div class="sub">用户换手机、清浏览器数据或误占设备名额时使用。重置后该码可以重新绑定设备。</div>
